...
function launchAnnotator() {
  ...
  _APP__WEBPACK_IMPORTED_MODULE_0__["APP"].DiskMode = 0; //Boundingbox
...
_APP__WEBPACK_IMPORTED_MODULE_0__["APP"].showDisks = function () {
...
_APP__WEBPACK_IMPORTED_MODULE_0__["APP"].hideDisks = function () {
...
_APP__WEBPACK_IMPORTED_MODULE_0__["APP"].addDiskObject = function (id, col) {
  ...
  */
  ...
  fetch(target_url).then(function (response) {
    ...
    disks.add(line);
    disks.name = name;
    _APP__WEBPACK_IMPORTED_MODULE_0__["APP"].scene.add(disks); //
    //
  });
}; // Change the color of a skeleton object specified by a name.


_APP__WEBPACK_IMPORTED_MODULE_0__["APP"].changeDiskObjectColor = function (id, col) {
...
_APP__WEBPACK_IMPORTED_MODULE_0__["APP"].hideDiskObject = function (id) {
  name = 'Disks' + ('0000000000' + id).slice(-10);
  var obj = _APP__WEBPACK_IMPORTED_MODULE_0__["APP"].scene.getObjectByName(name);
...
_APP__WEBPACK_IMPORTED_MODULE_0__["APP"].deleteDiskObject = function (id) {
  name = 'Disks' + ('0000000000' + id).slice(-10);
  var obj = _APP__WEBPACK_IMPORTED_MODULE_0__["APP"].scene.getObjectByName(name);
...
_SyncPaint__WEBPACK_IMPORTED_MODULE_1__["paintManager"].emitter.on("update", data => {
  if (data.room_id === "list") {
    ...
    const incomingRows = data.list || []; // console.log(incomingRows);
...
/* harmony import */ var _js_HandleDisks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../js/HandleDisks */ "./js/HandleDisks.js");
